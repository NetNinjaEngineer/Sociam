...
{
    public sealed class GroupsWithFilterationCountSpecification : BaseSpecification<Group>
    {
        public GroupsWithFilterationCountSpecification(GroupParams @params) : base(
